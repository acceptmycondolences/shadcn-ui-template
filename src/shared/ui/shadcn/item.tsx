...
function Item({
  ...
  return (
    <Comp
      className={classNames(itemVariants({ className, size, variant }))}
      data-size={size}
      data-slot="item"
...
function ItemActions({ className, ...props }: React.ComponentProps<'div'>) {
  return <div className={classNames('flex items-center gap-2', className)} data-slot="item-actions" {...props} />
}
...
function ItemFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      className={classNames('flex basis-full items-center justify-between gap-2', className)}
...
function ItemMedia({
  ...
  return (
    <div
      className={classNames(itemMediaVariants({ className, variant }))}
