...
function AlertDialogAction({
  ...
  return (
    <Button asChild size={size} variant={variant}>
      <AlertDialogPrimitive.Action className={classNames(className)} data-slot="alert-dialog-action" {...props} />
    </Button>
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <Button asChild size={size} variant={variant}>
      <AlertDialogPrimitive.Cancel className={classNames(className)} data-slot="alert-dialog-cancel" {...props} />
    </Button>
  )
}
