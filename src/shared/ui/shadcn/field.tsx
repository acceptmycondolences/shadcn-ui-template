...
function FieldLegend({
  ...
  return (
    <legend
      className={classNames('mb-3 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-base', className)}
...
function FieldContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      className={classNames('group/field-content flex flex-1 flex-col gap-1 leading-snug', className)}
...
function FieldError({
  ...
  return (
    <div
      className={classNames('text-sm font-normal text-destructive', className)}
...
function FieldSeparator({
  ...
  return (
    <div
      className={classNames('relative -my-2 h-5 text-sm group-data-[variant=outline]/field-group:-mb-2', className)}
