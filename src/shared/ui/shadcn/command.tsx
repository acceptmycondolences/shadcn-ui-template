...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={classNames('top-1/3 translate-y-0 overflow-hidden rounded-4xl! p-0', className)}
...
function CommandItem({ children, className, ...props }: React.ComponentProps<typeof CommandPrimitive.Item>) {
  return (
...
function CommandSeparator({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Separator>) {
  return (
    <CommandPrimitive.Separator
      className={classNames('my-1.5 h-px bg-border/50', className)}
