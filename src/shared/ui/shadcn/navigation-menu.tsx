...
function NavigationMenuList({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.List>) {
  return (
    <NavigationMenuPrimitive.List
      className={classNames('group flex flex-1 list-none items-center justify-center gap-0', className)}
...
function NavigationMenuViewport({
  ...
  return (
    <div className={classNames('absolute top-full left-0 isolate z-50 flex justify-center')}>
